...
import activemq.service.ConsumerService;
import activemq.service.JmsTransaction;
import activemq.service.ProducerService;
...
/*
	...
	@RequestMapping(value = "/jmsTransaction", method = RequestMethod.GET)
	public void jmsTransaction() throws Exception {
	 
	    //    jmsTransaction.receive();
